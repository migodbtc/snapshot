...
const SelectionCardModal = ({
  ...
  const modalContent =
    currentSelection != -1 ? SELECTION_GRID_CONSTS[currentSelection] : null;

  const mockHandle = (
    <b className="font-semibold text-rose-700 dark:text-rose-500">
      @miguel.justin
    </b>
  );
    ...
    >
      <div
        ...
        className={`
          ...
          ${selectionModalOpen ? "scale-100 opacity-100" : "scale-95 opacity-0"}
        `}
      >
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold">
            {modalContent && modalContent.label}
          </h2>
        ...
        <div className="flex flex-col gap-2">
            ...
            {modalContent && (
              <img
                src={
                  modalContent
                    ? modalContent.image
                    : "https://placehold.co/1000x400/1f2937/e5e7eb?text=Loading"
                }
          ...
          <div
            className="mt-2 w-full flex flex-row justify-between
          ...
          {/* Body */}
          <p className="my-2 text-justify sm:text-sm md:text-base">
            {mockHandle} {modalContent && modalContent.description}
          </p>
          ...
          >
            <span className="w-fit italic">
              Posted on July 7, 2026 at 4:10 PM PST
            </span>
            {modalContent && (
              <span className="text-right">
                Credit: {modalContent && modalContent.credit}
              </span>
            )}
          </div>
        </div>
  ...
  return (
    <main className="w-full h-fit min-h-[90vh] flex flex-col items-center">
      ...
      >
        ...
        <Link
          href="/"
          className="text-sm italic text-gray-600 dark:text-gray-500 font-semibold my-4 flex flex-row gap-2 items-center hover:underline hover:cursor-pointer uppercase"
        >
          <ArrowLeft size={16} />
        ...
        >
          ...
          >
            ...
            <span className="w-full h-fit text-sm">
              The cards below are interactable! Click on them and a modal will
              pop up.
            </span>
          </div>
        </div>
