    ...
    <main className="w-full h-fit flex flex-col items-center">
      ...
      >
        ...
        <p className="text-md text-gray-700 dark:text-gray-400 text-justify w-full mb-2">
          The following content below will display the skills that I am
          familiar, studied, and applied in some way shape or form. As I
          continue to grow, I will be able to achieve new skills with new
          technologies and tools as I continue to master the fundamentals of the
          existing skills I have.
        </p>
