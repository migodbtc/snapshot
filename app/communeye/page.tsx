    ...
    <main className="w-full h-fit flex flex-col items-center pb-8 min-h-[90vh]">
      ...
      >
        ...
        <p className="text-md text-gray-700 dark:text-gray-400 text-justify w-full mb-2">
          The Communeye Project is a project of mine which I produce various
          software, systems, and digital solutions under a separate brand
          independent of my name and professional experience. It is meant to be
          able to showchase projects and produce associated content to the
          masses. Right now, it functions as a casual, low-pressure sandbox — a
          place to share both Communeye-branded projects and other content,
          without a fixed posting schedule.
        </p>
        ...
        >
          ...
          >
            <div className="h-fit flex flex-col lg:col-span-2">
              ...
              <p className="text-md text-gray-700 dark:text-gray-400 text-justify w-full mb-2">
                Feel free to send your inquiries about the project and contact
                Communeye Software with the links below.
              </p>
            </div>
