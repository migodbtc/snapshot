  ...
  return (
    <section className="w-full aspect-video flex flex-row mb-8">
      <div className="flex flex-1 flex-col px-6 h-full items-start justify-center gap-3">
        ...
        <p className="text-justify w-full text-gray-700 dark:text-gray-400">
      ...
      <div className="flex flex-1 h-full items-center justify-center bg-radial from-slate-800 dark:from-slate-50/25 to-transparent to-70%">
