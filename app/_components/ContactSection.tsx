...
export const ContactSection = () => {
  ...
  return (
    <section className="min-h-[60vh] md:min-h-[70vh] lg:min-h-[75vh] flex flex-col w-full h-fit overflow-hidden mb-16 md:mb-20 lg:mb-24 mt-16 lg:mt-0 max-w-xl lg:max-w-5xl mx-auto">
